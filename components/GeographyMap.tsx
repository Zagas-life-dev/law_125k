...
// Coordinates based on the proper Africa SVG map (viewBox: 0 0 1000 1001)
// Positions calculated from actual country path coordinates
const cities = [
  { name: 'Lagos', country: 'Nigeria', x: '39%', y: '39%' }, // Southwest coast of Nigeria
  { name: 'Kigali', country: 'Rwanda', x: '66%', y: '54.4%' }, // Center of Rwanda
  { name: 'Addis Ababa', country: 'Ethiopia', x: '77.5%', y: '40%' }, // Central Ethiopia
  { name: 'Nairobi', country: 'Kenya', x: '76%', y: '51%' }, // South-central Kenya
]
...
export default function GeographyMap() {
  ...
  return (
    <section ref={ref} className="py-32 bg-luxury-black relative overflow-hidden">
      <div className="container mx-auto px-6 lg:px-16">
        ...
        >
          ...
          <h2 className="editorial-text text-5xl md:text-6xl lg:text-7xl font-bold text-luxury-white mb-4">
            Scouted Cities
          </h2>
        ...
        <div className="relative max-w-4xl mx-auto">
          {/* Map Container */}
          <div className="relative aspect-[1000/1001]"> 
            
            {/* Proper Africa Map SVG - Complete Map */}
            <svg
              viewBox="0 0 1000 1001"
              className="w-full h-full"
              style={{ filter: 'drop-shadow(0px 0px 10px rgba(255,255,255,0.1))' }}
              preserveAspectRatio="xMidYMid meet"
            >
              <defs>
                <style type="text/css">{`path { fill-rule: evenodd; }`}</style>
              </defs>
              <g className="text-luxury-white" fill="none" stroke="currentColor" strokeWidth="1">
                ...
                <path id="ZW" d="m 669.1,825.1 13.4,-15.7 3.6,-9.9 1.9,-1.3 1.7,-8.1 -1.7,-4.1 1,-10.4 2.8,-9.6 0.8,-17.5 -6.1,-4.4 -5.7,-1 -2.5,-3.4 -5.5,-3 -10,0.3 -0.6,-5.1 -9.3,1.9 -7,5.5 -1.7,4.8 -4.4,1 -10.9,11.4 -7,9 -4.1,0.3 -3.8,-1.6 -13.4,-1.5 4.2,11.1 2.3,2.4 3.5,8 13,15.2 5.1,1.5 -0.2,4.9 3.1,8.8 9.2,2.1 7.3,6.2 4.9,0.2 5.7,2.3 4.1,-1.6 6.3,1.3 z" />
                <path id="SO" d="m 832.6,372.8 -5.7,-5.8 -2.5,-5.7 -4.1,-2.6 -4.2,7.4 -2.5,4.9 4.8,7.7 4.6,6.6 4.8,5 40.3,16.4 10.3,-0.1 -33.5,41.5 -15.9,0.6 -10.7,9.8 -7.8,0.2 -3.3,4.4 -10.5,15.7 0.4,50.4 7.2,11.4 2.7,-3.3 2.9,-7.3 13.4,-16.7 11.4,-10.6 18.1,-13.7 12.1,-11.2 14.1,-18.9 10.1,-15.5 10,-20.2 7,-17.7 5.4,-15.5 2.9,-14.9 2.4,-5 -0.4,-7.3 0.8,-8 -0.5,-3.9 -4.6,0.1 -5.5,4.7 -6.4,1.4 -5.5,2.1 -3.9,0.2 0,0 -6.9,0.5 -4.2,2.6 -6,0.9 -10.5,4.3 -13.2,1.6 -11.3,3.5 -6.1,0 z" />
              </g>
            </svg>
            ...
            {cities.map((city, index) => (
              ...
              >
                <div className="relative group cursor-pointer -translate-x-1/2 -translate-y-1/2">
                  <div className="w-3 h-3 bg-luxury-white rounded-full border-2 border-luxury-black shadow-lg relative z-10" />
                  <motion.div
                    className="absolute inset-0 w-3 h-3 bg-luxury-white rounded-full z-0"
                    animate={{ scale: [1, 2.5, 2.5], opacity: [0.7, 0, 0] }}
                    transition={{ duration: 2, repeat: Infinity, delay: index * 0.3 }}
                  />
                  <div 
                    className={`absolute bottom-full left-1/2 transform -translate-x-1/2 mb-3 whitespace-nowrap transition-all duration-300
                    ${activeCity === city.name ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0'}
                    `}
                  >
                    <div className="bg-luxury-white text-luxury-black px-4 py-2 text-xs tracking-wider uppercase thin-text shadow-xl">
                      {city.name}
                      <div className="text-[10px] text-luxury-black/60 mt-0.5 font-bold">
                        {city.country}
                      </div>
                      <div className="absolute top-full left-1/2 -translate-x-1/2 border-l-[6px] border-l-transparent border-r-[6px] border-r-transparent border-t-[6px] border-t-luxury-white"></div>
                    </div>
                  </div>
                </div>
              </motion.div>
          ...
          >
            {cities.map((city) => (
              <div key={city.name} className="text-luxury-white/70">
                <div className="text-lg font-light mb-1 thin-text">{city.name}</div>
                <div className="text-xs text-luxury-white/40 tracking-wider uppercase">
                  {city.country}
                </div>
              </div>
            ))}
